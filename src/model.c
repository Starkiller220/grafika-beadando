...
void init_entities(World* world) {
	...
	world->room.ground = load_texture("textures//blue.jpg"); 
    world->room.middle4 = load_texture("textures//blue.jpg");    
    world->room.middlel2 = load_texture("textures//blue.jpg");

    world->room.ground2 = load_texture("textures//red.jpg");
    world->room.middle = load_texture("textures//red.jpg");    
    world->room.middle2l2 = load_texture("textures//red.jpg");

    world->room.ground3 = load_texture("textures//yellow.jpg");
    world->room.middle3l2 = load_texture("textures//yellow.jpg");
    world->room.middle2 = load_texture("textures//yellow.jpg");

    world->room.ground4 = load_texture("textures//purple.jpg");
    world->room.middle4l2 = load_texture("textures//purple.jpg");
    world->room.middle3 = load_texture("textures//purple.jpg");
